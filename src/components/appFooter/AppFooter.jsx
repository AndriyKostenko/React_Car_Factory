            ...
            <div className="container">
                <div className="app__footer-wrapper">
                    <div className="app__footer-socials">
                        <a href="https://ca.linkedin.com/company/toyotetsu-canada-inc">
                            <img src={linkedIn} alt="linkedIn_social" />
                        </a>
                        
                        <a href="https://www.facebook.com/ToyotetsuCanadaInc/">
                            <img src={facebook} alt="linkedIn_social" />
                        </a>

                        <a href="https://www.instagram.com/toyotetsucanada/">
                    ...
                    <div className="app__footer-contact">
                        ...
                        <div className='app__footer-contact-phone' >(519) 428-6500</div>
                        <div className='app__footer-contact-em-title'>Email:</div>
                        <div className='app__footer-contact-email'>ttca-jobs@ttna.com</div>
                    </div>
                    ...
                    <div className="app__footer-location">
                        ...
                        <div className='app__footer-location-adress'>88 Park Road Simcoe,ON N3Y 4J9</div>
